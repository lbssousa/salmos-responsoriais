...
<v>\VSup{1}</v>Dou-()vos() gra()ças,() ó() Se()nhor,() por()que,() es()tan()do() ir()ri()ta()do,() *(:)
a()cal()mou-()se() a() vos()sa() i()ra() e() en()fim() me() con()so()las()tes.() (::)
<v>\VSup{2}</v>Eis() o() Deus,() meu() Sal()va()dor,() eu() con()fi()o() e() na()da() te()mo;() *(:)
...
<v>\VSup{3}</v>Com() a()le()gri()a() be()be()reis() no() ma()nan()ci()al() da() sal()va()ção,() *(:)
<v>\VSup{4}</v>e() di()reis() na()que()le() di()a:() ``Dai() lou()vo()res() ao() Se()nhor,() (::)
...
<v>\VSup{5}</v>Lou()vai() can()tan()do() ao() nos()so() Deus,() que() fez() pro()dí()gios() e() por()ten()tos,() *(:)
pu()bli()cai() em() to()da() a() ter()ra() su()as() gran()des() ma()ra()vi()lhas!() (::)
<v>\VSup{6}</v>E()xul()tai() can()tan()do() a()le()gres,() ha()bi()tan()tes() de() Si()ão,() *(:)
