<v>\VSup{0}</v>Ou()vi,() na()ções,() a() pa()la()vra() do() Se()nhor() *(:)
...
<v>\VSup{1}</v>Pois,() na() ver()da()de,() o() Se()nhor() re()miu() Ja()có() *(:)
e() o() li()ber()tou() do() po()der() do() pre()po()ten()te.() (::)
<v>\VSup{12}</v>Vol()ta()rão() pa()ra() o() mon()te() de() Si()ão,() +(,)
