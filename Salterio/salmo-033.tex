...
<v>\VSup{16}</v>O() Se()nhor() pou()sa() seus() o()lhos() so()bre() os() jus()tos,() *(:)
e() seu() ou()vi()do() es()tá() a()ten()to() ao() seu() cha()ma()do;() (::)
<v>\VSup{17}</v>mas() e()le() vol()ta() a() su()a() fa()ce() con()tra() os() maus,() *(:)
...
<v>\VSup{18}</v>Cla()mam() os() jus()tos,() e() o() Se()nhor() bon()do()so() es()cu()ta() *(:)
e() de() to()das() as() an()gús()tias() os() li()ber()ta.() (::)
<v>\VSup{19}</v>Do() co()ra()ção() a()tri()bu()la()do() e()le() es()tá() per()to() *(:)
...
<v>\VSup{23}</v>Mas() o() Se()nhor() li()ber()ta() a() vi()da() dos() seus() ser()vos,() *(:)
