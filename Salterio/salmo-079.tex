...
<v>\VSup{5}</v>A()té() quan()do,() ó() Se()nhor,() vos() ir()ri()<b>tais</b>,(r1) *(:)
a()pe()sar() da() o()ra()ção() do() vos()so() <b>po</b>(r1)vo?() (::)
<v>\VSup{6}</v>Vós() nos() des()tes() a() co()mer() o() pão() das() <b>lá</b>(r1)gri()mas,() *(:)
e() a() be()ber() des()tes() um() pran()to() co()pi()<b>o</b>(r1)so.() (::)
<v>\VSup{7}</v>Pa()ra() os() vi()zi()nhos() so()mos() cau()sa() de() con()<b>ten</b>(r1)da,() *(:)
...
<v>\VSup{9}</v>Ar()ran()cas()tes() do() E()gi()to() es()ta() vi()<b>dei</b>(r1)ra,() *(:)
e() ex()pul()sas()tes() as() na()ções() pa()ra() plan()<b>tá</b>-(r1)la;() (::)
<v>\VSup{10}</v>Di()an()te() de()la() pre()pa()ras()tes() o() ter()<b>re</b>(r1)no,() *(:)
...
<v>\VSup{11}</v>Os() mon()tes() re()co()briu() com() su()a() <b>som</b>(r1)bra, *(:)
e() os() ce()dros() do() Se()nhor() com() os() seus() ra()mos;() (::)
<v>\VSup{12}</v>a()té() o() mar() se() es() ten() de() ram() seus() sar()<b>men</b>(r1)tos,() *(:)
...
<v>\VSup{13}</v>Por() que() ra()zão() vós() des()tru()ís()tes() su()a() <b>cer</b>(r1)ca,() *(:)
pa()ra() que() to()dos() os() pas()san()tes() a() vin()<b>di</b>(r1)mem,() *(:)
<v>\VSup{14}</v>o() ja()va()li() da() ma()ta() vir()gem() a() de()<b>vas</b>(r1)te,() *(:)
