...
<v>\VSup{2}</v>Quão() a()má()vel,() ó() Se()nhor,() é() vos()sa() <b>ca</b>(r1)sa, *(:)
quan()to() a() a()mo,() Se()nhor() Deus() do() u()ni()<b>ver</b>(r1)so!() (::)
<v>\VSup{3}</v>Mi()nha() al()ma() des()fa()le()ce() de() sau()<b>da</b>(r1)des() *(:)
...
<v>\VSup{5}</v>Fe()li()zes() os() que() ha()bi()tam() vos()sa() <b>ca</b>(r1)sa;() *(:)
pa()ra() sem()pre() ha()ve()rão() de() vos() lou()<b>var</b>!() (::)
<v>\VSup{6}</v>Fe()li()zes() os() que() em() vós() têm() su()a() <b>for</b>(r1)ça,() *(:)
...
<v>\VSup{9}</v>Deus() do() u()ni()ver()so,() es()cu()tai() mi()nha() o()ra()<b>ção</b>!(r1) *(:)
In()cli()nai,() Deus() de() Ja()có,() o() vos()so() ou()<b>vi</b(r1)do!() (::)
<v>\VSup{10}</v>O()lhai,() ó() Deus,() que() sois() a() nos()sa() pro()te()<b>ção</b>(r1) *(:)
