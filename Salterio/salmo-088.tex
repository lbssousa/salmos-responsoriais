...
<v>\VSup{2}</v>Ó() Se()nhor,() eu() can()ta()rei() e()ter()na()men()te() o() vos()so() a()<b>mor</b>,(r1) *(:)
de() ge()ra()ção() em() ge()ra()ção() eu() can()ta()rei() vos()sa() ver()<b>da</b>(r1)de!() (::)
<v>\VSup{3}</v>Por()que() dis()ses()tes:() ``O() a()mor() é() ga()ran()ti()do() pa()ra() <b>sem</b>(r1)pre!''() *(:)
...
<v>\VSup{4}</v>``Eu() fir()mei() u()ma() a()li()an()ça() com() meu() ser()vo,() meu() e()<b>lei</b>(r1)to,() *(:)
e() eu() fiz() um() ju()ra()men()to() a() Da()vi,() meu() ser()vi()<b>dor</b>:(r1) (::)
<v>\VSup{5}</v>Pa()ra() sem()pre,() no() teu() tro()no,() fir()ma()rei() tu()a() li()<b>nha</b>(r1)gem,() *(:)
...
<v>\VSup{16}</v>Quão() fe()liz() é() a()que()le() po()vo() que() co()nhe()ce() a() a()le()<b>gri</b>(r1)a;() *(:)
se()gui()rá() pe()lo() ca()mi()nho() sem()pre() à() luz() de() vos()sa() <b>fa</b>(r1)ce!() (::)
<v>\VSup{17}</v>E()xul()ta()rá() de() a()le()gri()a() em() vos()so() no()me() di()a() a() <b>di</b>(r1)a,() *(:)
...
<v>\VSup{27}</v>E()le,() en()tão,() me() in()vo()ca()rá:() ``Ó() Se()nhor,() vós() sois() meu() <b>Pai</b>,(r1) *(:)
sois() meu() Deus,() sois() meu() Ro()che()do() on()de() en()con()tro() a() sal()va()<b>ção</b>!''(r1) (::)
<v>\VSup{28}</v>E() por() is()so() fa()rei() de()le() o() meu() fi()lho() pri()mo()<b>gê</b>(r1)ni()to,() *(:)
...
<v>\VSup{29}</v>Guar()da()rei() e()ter()na()men()te() pa()ra() e()le() a() mi()nha() <b>gra</b>(r1)ça() *(:)
e() com() e()le() fir()ma()rei() mi()nha() a()li()an()ça() in()dis()so()<b>lú</b>(r1)vel.() (::)
<v>\VSup{30}</v>Pe()los() sé()cu()los() sem() fim() con()ser()va()rei() su()a()des()cen()<b>dên</b>(r1)cia,() *(:)
