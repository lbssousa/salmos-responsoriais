...
<v>\VSup{1}</v>Deus() é() Rei!() E()xul()te() a() ter()ra() de() a()le()<b>gri</b>(r1)a,() *(:)
e() as() i()lhas() nu()me()ro()sas() re()ju()<b>bi</b>(r1)lem!() (::)
<v>\VSup{2}</v>Tre()va() e() nu()vem() o() ro()dei()am() no() seu() <b>tro</b>(r1)no,() *(:)
que() se() a()poi()a() na() jus()ti()ça() e() no() di()<b>rei</b>(r1)to.() (::)
<v>\VSup{3}</v>Vai() um() fo()go() ca()mi()nhan()do() à() su()a() <b>fren</b>(r1)te() *(:)
...
<v>\VSup{4}</v>Seus() re()lâm()pa()gos() cla()rei()am() to()da() a() <b>ter</b>(r1)ra; *(:)
to()da() a() ter()ra() ao() con()tem()plá-()los() es()tre()<b>me</b>(r1)ce. (::)
<v>\VSup{5}</v>As() mon()ta()nhas() se() der()re()tem() co()mo() <b>ce</b>(r1)ra *(:)
an()te() a() fa()ce() do() Se()nhor() de() to()da() a() <b>ter</b>(r1)ra;() (::)
<v>\VSup{6}</v>e() as()sim() pro()cla()ma() o() céu() su()a() jus()<b>ti</b>(r1)ça,() *(:)
...
<v>\VSup{11}</v>U()ma() luz() já() se() le()van()ta() pa()ra() os() <b>jus</b>(r1)tos,() *(:)
e() a() a()le()gri()a,() pa()ra() os() re()tos() co()ra()<b>ções</b>.() (::)
<v>\VSup{12}</v>Ho()mens() jus()tos,() a()le()grai-()vos() no() Se()<b>nhor</b>,() *(:)
