...
<v>\VSup{2}</v>Ben()di()ze,() ó() mi()nha() al()ma,() ao() Se()<b>nhor</b>,(r1) *(:)
...
<v>\VSup{3}</v>Pois() e()le() te() per()do()a() to()da() <b>cul</b>(r1)pa,() *(:)
e() cu()ra() to()da() a() tu()a() en()fer()mi()<b>da</b>(r1)de;() (::)
<v>\VSup{4}</v>Da() se()pul()tu()ra() e()le() sal()va() a() tu()a() <b>vi</b>(r1)da() *(:)
e() te() cer()ca() de() ca()ri()nho() e() com()pai()<b>xão</b>;(r1) (::)
<v>\VSup{5}</v>de() bens() e()le() sa()ci()a() tu()a() <b>vi</b>(r1)da,() *(:)
...
<v>\VSup{8}</v>O() Se()nhor() é() in()dul()gen()te,() é() fa()vo()<b>rá</b>(r1)vel,() *(:)
é() pa()ci()en()te,() é() bon()do()so() e() com()pas()<b>si</b>(r1)vo.() (::)
<v>\VSup{9}</v>Não() fi()ca() sem()pre() re()pe()tin()do() as() su()as() <b>quei</b>(r1)xas,() *(:)
nem() guar()da() e()ter()na()men()te() o() seu() ran()<b>cor</b>.(r1) (::)
<v>\VSup{10}</v>Não() nos() tra()ta() co()mo() e()xi()gem() nos()sas() <b>fal</b>(r1)tas,() *(:)
