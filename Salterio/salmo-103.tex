...
<v>\VSup{1}</v>ben()di()ze()ó()mi()nha()al()ma()a()o()se()nhor
ó()meu()deus()e()meu()se()nhor()co()mo()sois()gran()de
<v>\VSup{2}</v>de()ma()jes()ta()de()e()es()plen()dor()vos()re()ves()tis
...
<v>\VSup{3}</v>es()ten()deis()qual()u()ma()ten()da()o()fir()ma()men()to
...
<v>\VSup{4}</v>dos()ven()tos()fa()zeis()vos()sos()men()sa()gei()ros
...
<v>\VSup{27}</v>to()dos()e()les()ó()se()nhor()de()vós()es()pe()ram
que()a()seu()tem()po()vós()lhes()deis()o()a()li()men()to
<v>\VSup{28}</v>vós()lhes()dais()o()que()co()mer()e()e()les()re()co()lhem
...
<v>\VSup{30}</v>en()vi()ais()o()vos()so()es()pí()ri()to()e()re()nas()cem
