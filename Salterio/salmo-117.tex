...
<v>\VSup{2}</v>A() ca()sa() de() Is()ra()el() a()go()ra() o() di()ga() (::)
``E()ter()na() é() a() su()a() mi()se()ri()cór()dia!''() (::)
<v>\VSup{3}</v>A() ca()sa() de() A()a()rão() a()go()ra() o() di()ga: *(:)
``E()ter()na() é() a() su()a() mi()se()ri()cór()dia!''() (::)
<v>\VSup{4}</v>Os() que() te()mem() o() Se()nhor() a()go()ra() o() di()gam:() *(:)
``E()ter()na() é() a() su()a() mi()se()ri()cór()dia!''() (::)
...
<v>\VSup{8}</v>``É() me()lhor() bus()car() re()fú()gio() no() Se()nhor,() *(:)
do() que() pôr() no() ser() hu()ma()no( )a() es()pe()ran()ça;() (::)
<v>\VSup{9}</v>É() me()lhor() bus()car() re()fú()gio() no() Se()nhor,() *(:)
...
<v>\VSup{19}</v>A()bri-()me() vós,() a()bri-()me() as() por()tas() da() jus()ti()ça;() *(:)
que()ro() en()trar() pa()ra() dar() gra()ças() ao() Se()nhor!() (::)
<v>\VSup{20}</v>``Sim,() es()ta() é() a() por()ta() do() Se()nhor,() *(:)
por() e()la() só() os() jus()tos() en()tra()rão!''() (::)
<v>\VSup{21}</v>Dou-()vos() gra()ças,() ó() Se()nhor,() por()que() me() ou()vis()tes() *(:)
...
<v>\VSup{25}</v>Ó() Se()nhor,() dai-()nos() a() vos()sa() sal()va()ção,() *(:)
ó() Se()nhor,() dai-()nos() tam()bém() pros()pe()ri()da()de!() (::)
<v>\VSup{26}</v>Ben()di()to() se()ja() em() no()me() do() Se()nhor,() *(:)
a()que()le() que() em() seus() á()trios() vai() en()tran()do!() (::)
Des()ta() ca()sa() do() Se()nhor() vos() ben()di()ze()mos.() *(:)
<v>\VSup{27}</v>Que() o() Se()nhor() e() nos()so() Deus() nos() i()lu()mi()ne!() (::)
