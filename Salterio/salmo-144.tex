...
<v>\VSup{1}</v>Ó() meu() Deus,() que()ro() e()xal()tar-()vos,() ó() meu() <b>Rei</b>,(r1) *(:)
...
<v>\VSup{8}</v>Mi()se()ri()cór()dia() e() pi()e()da()de() é() o() Se()<b>nhor</b>,(r1) *(:)
e()le() é() a()mor,() é() pa()ci()ên()cia,() é() com()pai()<b>xão</b>.(r1) (::)
<v>\VSup{9}</v>O() Se()nhor() é() mui()to() bom() pa()ra() com() <b>to</b>(r1)dos,() *(:)
...
<v>\VSup{10}</v>Que() vos()sas() o()bras,() ó() Se()nhor,() vos() glo()ri()<b>fi</b>(r1)quem,() *(:)
e() os() vos()sos() san()tos() com() lou()vo()res() vos() ben()<b>di</b>(r1)gam!() (::)
<v>\VSup{11}</v>Nar()rem() a() gló()ria() e() o() es()plen()dor() do() vos()so() <b>rei</b>(r1)no() *(:)
...
<v>\VSup{12}</v>Pa()ra() es()pa()lhar() vos()sos() pro()dí()gios() en()tre() os() <b>ho</b>(r1)mens() *(:)
e() o() ful()gor() de() vos()so() rei()no() es()plen()do()<b>ro</b>(r1)so.() (::)
<v>\VSup{13}</v>O() vos()so() rei()no() é() um() rei()no() pa()ra() <b>sem</b>(r1)pre,() *(:)
